// BOB Basement DOOR sensor fixture - Page Object Model
class BobBasementDoor {
  constructor(page) {
    this.page = page;
    this.apiUrl = 'https://dev-functions.grtinsight.com/api/Skylink';
    this.sensorData = {
      timestamp: Date.now() / 1000, // Unix timestamp in seconds
      deviceId: "BOB Basement",
      client_name: "GRT Health",
      payload_type: "DOOR",
      frame_type: "DOOR_OPENED",
      temp: "20",
      detection_bin_seq: "00000000000000000000000000000000000000000000000000000",
      battery: 2.9,
...
module.exports = BobBasementDoor;
